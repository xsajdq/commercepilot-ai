...
what's next. This repo is currently at the end of **Phase 0** (bootstrap):
no auth, domain model, or connectors exist yet.
...
migrations/   Alembic migrations (added Phase 2)
tests/
